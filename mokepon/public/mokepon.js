...
class Mokepon{
    constructor(nombre, foto, vida, fotoMapa, id = null) {
        ...
        this.vida = vida
        this.ataques = []
        this.ancho = mapa.width*.09
        this.alto = mapa.height*.09
...
tucapalma.ataques.push(... tucapalamaAtaques)
...
function unirseAlJuego(){
    fetch("http://192.168.1.42:8080/unirse")
        .then(function(res){
            if(res.ok){
                res.text()
...
function seleccionarMascotaJugador(){
    if (inputHipodoge.checked){
        ...
        alert("Seleccionaste Mal, vuelve a escoger")
        return
    }
...
function seleccionarMokepon(mascotaJugador){
    fetch(`http://192.168.1.42:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques(){
    fetch(`http://192.168.1.42:8080/mokepon/${jugadorId}/ataques`,{
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function obtenerAtaques(){
    fetch(`http://192.168.1.42:8080/mokepon/${enemigoId}/ataques`)
        .then(function(res){
            if(res.ok){
                res.json()
...
function enviarPosicion(x, y){
    fetch(`http://192.168.1.42:8080/mokepon/${jugadorId}/posicion`,{
        method: "post",
        headers:{
            "Content-Type": "application/json"
        },
...
function moverDerecha(){
    mascotaJugadorObjeto.velocidadX = 0.00625*mapa.width
}
...
function moverArriba(){
    mascotaJugadorObjeto.velocidadY = -0.00625*mapa.height
}
